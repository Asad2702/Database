    ...
    value.map((v, i) => {
      ...
      product.innerHTML += `
        <tr>
          ...
          <td>
          <button id=${v.Product_Key} ONCLICK ="edit_pro(this)" class="btn btn-secondary" > Edit</button>
        </td>
          <td>  <button id=${v.Product_Key} ONCLICK ="delete_pro(this)" class="btn btn-secondary" > Delete</button></td>
